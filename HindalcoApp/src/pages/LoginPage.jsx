        ...
        <div className="relative z-10 h-full flex flex-col justify-center items-center p-12">
          <div className="max-w-md text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Log in to report issues, track progress, and help us improve our services.
            </p>
          <div className="p-4">
            <Lottie 
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="max-w-md w-full">
          ...
          <div className="relative mb-10">
            ...
            <div className="relative text-center">
              <h1 className="text-3xl font-bold text-gray-900 mb-2">
                Client <span className="text-red-500">Login</span>
              </h1>
          ...
          <div className="mt-8 text-center text-sm text-gray-500">
            <p>By continuing, you agree to our <a href="#" className="text-red-500 hover:underline">Terms of Service</a>.</p>
          </div>
        </div>
      </div>
    </div>
