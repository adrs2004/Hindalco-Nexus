                        ...
                        return (
                          <tr key={issue._id} className="hover:bg-gray-50 transition-colors">
                            <td className="px-6 py-4 max-w-xs break-words">
                              <div className="text-sm font-semibold text-gray-900 mb-1">{issue.title}</div>
                              <div className="text-xs text-gray-600 whitespace-pre-wrap">{issue.description}</div>
                              {issue.photos?.length > 0 && (
                                <div className="mt-2 flex flex-wrap gap-1">
                                  ...
                                  {issue.photos.length > 2 && (
                                    <span className="text-xs text-gray-400 self-center">+{issue.photos.length - 2} more</span>
                                  )}
                                </div>
                              )}
                            </td>
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="grid grid-cols-2 gap-2 text-sm">
                            ...
                            <div>
                              ...
                              <select
                                className="w-full px-2 py-1 border rounded-md bg-gray-50 focus:outline-none focus:ring-2 focus:ring-green-400 text-xs"
                                value={issue.status}
                                onChange={(e) => updateStatus(issue._id, e.target.value)}
                              >
                                <option value="pending">Pending</option>
