...
<div className="absolute top-0 left-1/2 w-32 h-32 bg-violet-300 rounded-full mix-blend-multiply opacity-20 z-0"></div>
      ...
      <div className="container mx-auto px-4 py-2 flex justify-between items-center relative z-10">
        ...
        <div className="hidden md:flex items-center space-x-4">
          {adminInfo ? (
            <>
              <Link to="/team-management" className="text-gray-800 font-semibold hover:text-purple-600 transition-colors">
                Team Management
              </Link>
              <Link to="/reports" className="text-gray-800 font-semibold hover:text-purple-600 transition-colors">
                Reports
              </Link>
              <button
      ...
      {menuOpen && (
        <div className="md:hidden px-4 pb-4 relative z-10">
          <div className="flex flex-col space-y-2">
            {adminInfo ? (
              <>
                <Link to="/team-management" className="text-gray-800 font-semibold hover:text-purple-600">
                  Team Management
                </Link>
                <Link to="/reports" className="text-gray-800 font-semibold hover:text-purple-600">
                  Reports
                </Link>
                <button
                  onClick={handleLogout}
              ...
              <>
                {location.pathname === '/login' && (
                  <Link
                    to="/register"
                    className="bg-purple-500 hover:bg-purple-600 text-white px-4 py-2 rounded-md text-center"
                  >
                    Register Admin
                  </Link>
                )}
